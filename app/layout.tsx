                ...
                whatsappToggle.innerHTML = \`
                  ...
                  ">
                    ...
                    " onmouseover="this.style.backgroundColor='#f5f5f5'" onmouseout="this.style.backgroundColor='white'">
                      ...
                      "></div>
                      <div>
                        <div style="font-weight: 600; font-size: 13px;">UK Support</div>
                        <div style="font-size: 12px; color: #666;">+44 7700 144320</div>
                      </div>
                    </a>
                    ...
                    " onmouseover="this.style.backgroundColor='#f5f5f5'" onmouseout="this.style.backgroundColor='white'">
                      ...
                      <div>
                        <div style="font-weight: 600; font-size: 13px;">US Support</div>
                        <div style="font-size: 12px; color: #666;">+1 979 618 8876</div>
                      </div>
                    </a>
                  </div>
                \`;
